    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='All photos in the gallery will be given a title made up of the gallery title + a sequential number.', max_length=75, verbose_name='title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('image', models.ImageField(upload_to=photologue.models.get_storage_path, verbose_name='image', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text='Photo size name should contain only letters, numbers and underscores. Examples: "thumbnail", "display", "small", "main_page_widget".', unique=True, max_length=64, verbose_name='name')),
        ...
        migrations.AddField(
            ...
            name='effect',
            field=models.ForeignKey(related_name='imageoverride_related', verbose_name='effect', blank=True, to='photologue.PhotoEffect', null=True),
        ),
        migrations.AddField(
            model_name='imageoverride',
            name='photosize',
